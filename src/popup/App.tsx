...
const App = memo(function App() {
  const accessTokenQuery = useSWR('accessToken', () => Browser.runtime.sendMessage({
  ...
  return <div className="flex flex-col h-full">
      ...
      {isChrome && !hideShortcutsTipQuery.isLoading && !hideShortcutsTipQuery.data && <p className="m-0 mb-2">
          Tip:{' '}
      ...
      if (accessTokenQuery.isLoading) {
        return <div className="grow justify-center items-center flex animate-bounce">
              <GlobeIcon size={24} />
            </div>;
      }
