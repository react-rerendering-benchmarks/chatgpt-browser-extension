...
const ChatGPTCard = memo(function ChatGPTCard(props: Props) {
  ...
  if (props.triggerMode === TriggerMode.QuestionMark) {
    ...
    return <p className="icon-and-text">
  ...
  return <p className="icon-and-text cursor-pointer" onClick={() => setTriggered(true)}>
